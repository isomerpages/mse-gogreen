...
<div class="row row_custom">
  <!-- Invasive Species Management (ISM) Programme -->
  <div class="programmes__item col is-one-third">
    <div class="programmes__item__wrapper">
      <div class="programmes__item__header">
        <img src="/images/Tours/invasive%20species%20management%20programme.jpg">
        <h2>Invasive Species Management (ISM) Programme</h2>
      </div>
      <div class="programmes__item__detail">
        <ul>
          <li><strong>Date: 14 July, 2:30pm - 4:30pm</strong></li>
          <li>
            <strong>Admission: Free (registration required)</strong>
          </li>
          <li>
            <strong>Venue: Rail Corridor (South)</strong>
          </li>
      ...
      <div class="programmes__item__body">
        <p>
          Be a weed warrior for a day and make a difference to Singapore’s
          biodiversity and native flora along the Rail Corridor!
        </p>
      </div>
    </div>
    <div class="programmes__item__actions">
      <a href="/invasive-species-management-ism-programme" class="button-primary">
        Find out more
      </a>
    </div>
  </div>
